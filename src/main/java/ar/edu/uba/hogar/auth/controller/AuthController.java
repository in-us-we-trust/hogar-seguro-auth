...
public class AuthController {
  ...
  @Operation(
      ...
      description = "Crea una nueva cuenta con email y contraseña")
  @ApiResponses(
      value = {
  ...
  @Operation(
      ...
      description = "Verifica que el JWT sea válido y devuelve su payload")
  @ApiResponses(
      value = {
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "400",
            description = "Token inválido, expirado o contraseña ya usada",
            content =
                @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = ExceptionContent.class))),
